            ...
            <div className="z-10 grid gap-5 md:grid-cols-6 lg:grid-cols-9">
                ...
                <div className="col-span-3 font-sans text-gray-700 bg-gray-50 rounded-3xl">
                    <div className="box-border flex flex-col items-start h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:flex-row sm:items-start sm:text-left">
                        <div className="flex-shrink-0 p-3 font-sans text-gray-700 border border-gray-200 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" className="leading-6 text-center text-gray-700 align-middle stroke-current w-7 h-7" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div className="mt-4 font-sans text-left text-gray-700 border-0 border-gray-200 sm:mt-2 sm:ml-4">
                            <h6 className="box-border text-2xl font-bold leading-none tracking-wide text-left border-solid">Projects</h6>
                            <p className="box-border mx-0 mt-1 mb-0 font-medium leading-loose text-gray-400 border-solid sm:mt-4">
                                A Backend should serve your projects as they grow
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-span-3 font-sans text-gray-700 bg-gray-50 rounded-3xl">
                    <div className="box-border flex flex-col items-start h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:flex-row sm:items-start sm:text-left">
                        ...
                        <div className="mt-4 font-sans text-left text-gray-700 border-0 border-gray-200 sm:mt-2 sm:ml-4">
                            <h6 className="box-border text-2xl font-bold leading-none tracking-wide text-left border-solid">Evolutive</h6>
                            <p className="box-border mx-0 mt-1 mb-0 font-medium leading-loose text-gray-400 border-solid sm:mt-4">
                                A backend should always been open to Evolution
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-span-3 font-sans text-gray-700 bg-gray-50 rounded-3xl">
                    <div className="box-border flex flex-col items-start h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:flex-row sm:items-start sm:text-left">
                        ...
                        <div className="mt-4 font-sans text-left text-gray-700 border-0 border-gray-200 sm:mt-2 sm:ml-4">
                            <h6 className="box-border text-2xl font-bold leading-none tracking-wide text-left border-solid">Automation</h6>
                            <p className="box-border mx-0 mt-1 mb-0 font-medium leading-loose text-gray-400 border-solid sm:mt-4">
                                Set it, and forget it. Automated tools will allow you to automate your workflow.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-span-3 font-sans text-gray-700 bg-gray-50 rounded-3xl">
                    <div className="box-border flex flex-col items-start h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:flex-row sm:items-start sm:text-left">
                        ...
                        <div className="mt-4 font-sans text-left text-gray-700 border-0 border-gray-200 sm:mt-2 sm:ml-4">
                            <h6 className="box-border text-2xl font-bold leading-none tracking-wide text-left border-solid">Simple</h6>
                            <p className="box-border mx-0 mt-1 mb-0 font-medium leading-loose text-gray-400 border-solid sm:mt-4">
                                The simplest tools should integrate into your current system.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-span-3 font-sans text-gray-700 bg-gray-50 rounded-3xl">
                    <div className="box-border flex flex-col items-start h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:flex-row sm:items-start sm:text-left">
                        ...
                        <div className="mt-4 font-sans text-left text-gray-700 border-0 border-gray-200 sm:mt-2 sm:ml-4">
                            ...
                            <p className="box-border mx-0 mt-1 mb-0 font-medium leading-loose text-gray-400 border-solid sm:mt-4">
                                A backend should have the fast response times to fullfill their objectives
                            </p>
                        </div>
                    </div>
                </div>
