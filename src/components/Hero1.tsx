...
<div className="py-16 bg-white md:py-24">
    <div className="flex flex-col max-w-6xl px-10 mx-auto lg:flex-row">
        ...
        <div className="flex flex-col items-start justify-center w-full pr-10 mb-12 lg:w-1/2 lg:mb-0 order-2 lg:order-first">
            <h1 className="relative z-20 text-5xl font-extrabold leading-none text-purple-500 xl:text-6xl sm:text-center lg:text-left mx-auto">
                Frédéric Lang<br/>
            ...
            <div className="relative flex mt-4 mx-auto">
                <a href="#technologies" className="flex items-center self-start justify-center px-5 py-2 mt-5 text-base font-medium leading-tight text-white transition duration-150 ease-in-out bg-purple-500 border border-transparent rounded-full shadow lg:py-4 hover:bg-purple-600 focus:outline-none focus:border-purple-600 focus:shadow-outline-purple md:text-lg xl:text-xl md:px-5 xl:px-10">Get Started</a>
                <a href="/realisations" className="relative flex items-center self-start justify-center py-2 pl-10 pr-5 mt-5 ml-5 text-base font-medium leading-tight text-gray-400 transition duration-150 ease-in-out bg-gray-100 border-transparent rounded-full shadow-sm lg:py-4 md:pl-16 md:pr-5 xl:pr-10 hover:text-purple-500 focus:outline-none md:text-lg xl:text-xl">
                    ...
                    <span className="text-purple-500">Watch my realisations</span>
                </a>
            </div>
        </div>
