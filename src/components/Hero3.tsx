...
const Tricks = () => (
    ...
    <section className="py-20 bg-white" id="values">
        <div className="mx-auto">
            <h2 className="text-4xl font-bold tracking-tight text-center">Values</h2>
            <p className="mt-2 text-lg text-center text-gray-600">How to achieve great software </p>

            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 grid-flow-row gap-6">

                <div className="col-span-1 flex flex-col items-center justify-between px-8 py-12 space-y-4 overflow-hidden bg-gray-100 sm:rounded-xl">
                    ...
                    <p className="text-base text-center text-gray-500">I am certified from Fitec DevOps certification and I have a master degree in Computer science.</p>
                </div>
                <div className="col-span-1 flex flex-col items-center justify-between px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                    <div className="p-3 text-white bg-blue-500 rounded-full">
                    ...
                    <h4 className="text-xl font-medium text-gray-700">Communication</h4>
                    <p className="text-base text-center text-gray-500">I like to communicate on my work</p>
                </div>
                <div className="flex flex-col items-center justify-between px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                <div className="p-3 text-white bg-blue-500 rounded-full">
                ...
                <p className="text-base text-center text-gray-500">I like to deliver my work on time and let it be well documented.</p>
                </div>
                <div className="flex flex-col items-center justify-between px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                <div className="p-3 text-white bg-blue-500 rounded-full">
                ...
                <h4 className="text-xl font-medium text-gray-700">Developer</h4>
                <p className="text-base text-center text-gray-500">Developer since I am 14, It is my very activity. My experience let me enter a project quickly.</p>
                </div>
                <div className="flex flex-col items-center justify-between px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                <div className="p-3 text-white bg-blue-500 rounded-full">
                ...
                <h4 className="text-xl font-medium text-gray-700">Learning</h4>
                <p className="text-base text-center text-gray-500">I like to know that there always something new in a project.</p>
                </div>
                <div className="flex flex-col items-center justify-between px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                <div className="p-3 text-white bg-blue-500 rounded-full">
                ...
                <h4 className="text-xl font-medium text-gray-700">Involvment</h4>
                <p className="text-base text-center text-gray-500">Once involved in a project, I like to do the most to see it achieve its goals.</p>
                </div>
            </div>
        </div>
      </section>
