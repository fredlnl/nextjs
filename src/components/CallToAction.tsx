...
const CallToAction = () => (
<section className="py-20 bg-white" id="calltoaction">
    <div className="px-4 mx-auto text-center max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mt-8 space-x-3">
            ...
            <a href="/CV_FL.pdf" download className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-indigo-700 bg-indigo-100 border border-transparent rounded-md hover:bg-indigo-200">Get My CV</a>
        </div>
    </div>
</section>
)
